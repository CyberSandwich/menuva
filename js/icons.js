...
var MENU_KEYWORDS=[
  ...
  {i:'amphora',w:['tea','chai','matcha']},
  {i:'fish',w:['fish','seafood','sushi','japanese','maki','sashimi','ocean']},
  {i:'wine',w:['wine','vineyard','winery','vino','bistro']},
  {i:'beer',w:['pub','beer','ale','brewery','tavern','lager','stout',' bar']},
  {i:'milk',w:['milk','dairy','creamery']},
  {i:'pizza',w:['pizza','pizzeria']},
  {i:'hamburger',w:['burger','smash','patty']},
  {i:'sandwich',w:['sandwich','sub','deli','panini','wrap','taco','burrito','nacho','quesadilla','mexican','kebab','shawarma']},
  {i:'soup',w:['noodle','ramen','pho','udon','soba','pasta','spaghetti','soup','bowl','curry','rice','thai','indian','chinese','asian','wok','acai','poke']},
  {i:'shrimp',w:['prawn','shrimp','lobster','crab','scampi']},
  {i:'beef',w:['steak','beef','bbq','grill','smokehouse','barbecue','meat']},
  {i:'drumstick',w:['chicken','wing','fried','rotisserie','nugget','tender']},
  {i:'bird',w:['duck','peking','turkey','goose','quail']},
  {i:'ham',w:['ham','bacon','pork','sausage','hot dog','hotdog','charcuterie']},
  {i:'egg-fried',w:['egg','omelette','omelet','frittata']},
  {i:'croissant',w:['croissant','boulangerie','patisserie','brioche','french','bread','bagel','toast','loaf']},
  {i:'chef-hat',w:['bakery','bake','bake-shop','kitchen']},
  {i:'cake-slice',w:['cake','cupcake','gateau','tart','pie']},
  {i:'dessert',w:['dessert','pudding','mousse','parfait','tiramisu']},
  {i:'cookie',w:['cookie','biscuit','cookies','macaron','shortbread']},
  {i:'donut',w:['donut','doughnut']},
  {i:'ice-cream-cone',w:['ice cream','gelato','frozen','yogurt','froyo','sorbet']},
  {i:'candy',w:['candy','sweet','sweets','confection']},
  {i:'lollipop',w:['lollipop','lolly']},
  {i:'popcorn',w:['popcorn','cinema','movie']},
  {i:'apple',w:['apple','orchard','fruit']},
  {i:'banana',w:['banana','tropical']},
  {i:'cherry',w:['cherry','berry','strawberry']},
  {i:'grape',w:['grape','raisin']},
  {i:'citrus',w:['citrus','orange','lemon','lime']},
  {i:'carrot',w:['carrot','root','farm']},
  {i:'wheat',w:['wheat','grain','cereal','oat','corn']},
  {i:'nut',w:['nut','almond','walnut','hazelnut','pecan','cashew','peanut']},
  {i:'salad',w:['salad','greens']},
  {i:'leafy-green',w:['vegan','vegetarian','veggie','plant','organic','herb']},
  {i:'sprout',w:['sprout','microgreen','seedling']},
  {i:'leaf',w:['leaf','green','natural','fresh','mint']},
  {i:'cooking-pot',w:['kitchen','stew','hotpot','hot pot']},
  {i:'egg',w:['breakfast','brunch','diner','pancake','waffle']},
  {i:'store',w:['street','truck','cart','vendor','stall','market','shop']},
  {i:'rabbit',w:['rabbit','bunny']},
