...
| Segment | UK Size | Why Menuva |
| --- | --- | --- |
| Dietary-restricted diners | 5.9M adults | Cannot safely order without clear allergen data |
| International students | 700K | Navigating unfamiliar menus in a second language |
| Anxious diners (Gen Z) | 13.2M | 86% report stress when ordering at a restaurant |

### Market sizing

| Tier | Scope | Scale |
| --- | --- | --- |
| SOM | 25 UK university cities | 5,000 venues |
| SAM | All UK food service venues | 186,000 venues |
| TAM | Global restaurant digitalization | $7.9 billion |
