...
**1.1** Menuva 处理有限的个人数据（主要是分析事件数据和在线标识符），受[英国通用数据保护条例](https://www.legislation.gov.uk/eur/2016/679/contents)（UK GDPR）和[《2018 年数据保护法》](https://www.legislation.gov.uk/ukpga/2018/12/contents)约束。
...
**3.1** 我们已根据 ICO 的《适龄设计准则》(AADC) 对 Menuva 进行了评估。该准则根据[《2018 年数据保护法》第 123 条](https://www.legislation.gov.uk/ukpga/2018/12/section/123)制定，为可能被儿童访问的在线服务制定了 15 项适龄设计标准。
...
**4.1** Menuva 不是[《欧盟法规 (EU) No 1169/2011》](https://www.legislation.gov.uk/eur/2011/1169/contents)或[《2014 年食品信息条例》](https://www.legislation.gov.uk/uksi/2014/1855/contents)所定义的食品经营者 (FBO)。Menuva 不制作、销售或供应食品。我们是一个展示参与餐厅提供的菜单和过敏原信息的数字平台。
